      ...
      <header className="fixed-top site__header">
        <div className="d-flex align-items-center justify-content-between">
          ...
          <div className="d-flex align-items-center">
            <Themetoggle />
            <button className="menu__button nav_ac" onClick={handleToggle} aria-label="Toggle menu">
        ...
        <div className={`site__navigation ${isActive ? "menu__opend" : ""}`}>
              ...
              <div className="menu__container p-3">
                <ul className="the_menu">
                  <li className="menu_item">
                    <Link onClick={closeMenu} to="/" className="my-3">Home</Link>
                  </li>
                  <li className="menu_item">
                    <Link onClick={closeMenu} to="/portfolio" className="my-3">Portfolio</Link>
                  </li>
                  <li className="menu_item">
                    <Link onClick={closeMenu} to="/about" className="my-3">About</Link>
                  </li>
                  <li className="menu_item">
                    <Link onClick={closeMenu} to="/contact" className="my-3">Contact</Link>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="menu_footer d-flex flex-column flex-md-row justify-content-between align-items-md-center position-absolute w-100 p-3">
            <div className="menu_social_icons d-flex gap-3">
